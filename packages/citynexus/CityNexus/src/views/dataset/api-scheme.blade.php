<div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{action('\CityNexus\CityNexus\Http\DatasetController@postCreateScheme', $table_id)}}" method="post">
                    {{csrf_field()}}
                    <input type="hidden" name="uploader_settings" value="{{$settings}}">
