@foreach($results as $result)
    ...
    <div class="list-group-item @if($result->id == $id) disabled @endif">
        ...
        <a class="btn btn-primary btn-xs pull-right" href="{{action('\CityNexus\CityNexus\Http\CitynexusController@getProperty', ['property_id' => $result->id])}}" target="_blank">Profile</a>
    </div>
