<input type="hidden" name="key" value="{{dd($field)}}">
...
<div class="form-horizontal">
    ...
    <section id="calculate" class="function-settings hidden">
        <div class="form-group">
            <label for="range" class="control-label col-sm-3">Calculation Type</label>
        ...
        <div class="form-group">
            <label for="score" class="control-label col-sm-3">Factor</label>
